...
interface Ddth_Dao_IDao {
     ...
     *            indicates that if a transaction is automatically started
     * @return mixed the connection, or NULL if the connection can not be
     *         created
     */
     ...
     *
     * Normally this function closes the open connection only when necessary.
     * Set $forceClose
     * to force the open connection to be closed.
     *
     * @param bool $hasError
     *            indicates that an error has occurred during the usage of the
     *            connection
